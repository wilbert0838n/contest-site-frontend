            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
                ...
                <div className="bg-slate-200/50 p-1 rounded-lg inline-flex w-full sm:w-auto">
                    <button
                        ...
                        className={`flex-1 sm:flex-none flex justify-center items-center gap-2 px-5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 ${activeTab === 'problem'
                    ...
                    <button
                        ...
                        className={`flex-1 sm:flex-none flex justify-center items-center gap-2 px-5 py-1.5 rounded-md text-sm font-semibold transition-all duration-200 ${activeTab === 'submissions'
                            ? 'bg-white text-slate-900 shadow-sm'
                            : 'text-slate-500 hover:text-slate-700'
                            }`}
                    >
